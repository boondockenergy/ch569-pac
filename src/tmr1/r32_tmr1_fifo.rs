...
pub struct W(crate::W<R32_TMR1_FIFO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R32_TMR1_FIFO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R32_TMR1_FIFO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R32_TMR1_FIFO_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type R32_TMR1_FIFO_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_TMR1_FIFO_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - TMR current count"]
    #[inline(always)]
    pub fn r32_tmr1_fifo(&mut self) -> R32_TMR1_FIFO_W<0> {
        R32_TMR1_FIFO_W::new(self)
    }
...
impl crate::Writable for R32_TMR1_FIFO_SPEC {
    type Writer = W;
}
