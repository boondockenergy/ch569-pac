...
pub struct RegisterBlock {
    ...
    pub r8_spi1_clock_div_r8_spi1_slave_pre: R8_SPI1_CLOCK_DIV_R8_SPI1_SLAVE_PRE,
    ...
    pub r32_spi1_dma_now: R32_SPI1_DMA_NOW,
    #[doc = "0x18 - SPI1 DMA begin address"]
    pub r32_spi1_dma_beg: R32_SPI1_DMA_BEG,
    #[doc = "0x1c - SPI1 DMA end address"]
    pub r32_spi1_dma_end: R32_SPI1_DMA_END,
}
...
#[doc = "R8_SPI1_CLOCK_DIV_R8_SPI1_SLAVE_PRE (rw) register accessor: an alias for `Reg<R8_SPI1_CLOCK_DIV_R8_SPI1_SLAVE_PRE_SPEC>`"]
pub type R8_SPI1_CLOCK_DIV_R8_SPI1_SLAVE_PRE =
    crate::Reg<r8_spi1_clock_div_r8_spi1_slave_pre::R8_SPI1_CLOCK_DIV_R8_SPI1_SLAVE_PRE_SPEC>;
#[doc = "SPI1 master clock divisor _ SPI1 slave preset value"]
pub mod r8_spi1_clock_div_r8_spi1_slave_pre;
#[doc = "R8_SPI1_BUFFER (r) register accessor: an alias for `Reg<R8_SPI1_BUFFER_SPEC>`"]
...
#[doc = "R8_SPI1_FIFO_COUNT (rw) register accessor: an alias for `Reg<R8_SPI1_FIFO_COUNT_SPEC>`"]
...
#[doc = "R8_SPI1_FIFO_COUNT1 (rw) register accessor: an alias for `Reg<R8_SPI1_FIFO_COUNT1_SPEC>`"]
...
#[doc = "R32_SPI1_DMA_NOW (rw) register accessor: an alias for `Reg<R32_SPI1_DMA_NOW_SPEC>`"]
pub type R32_SPI1_DMA_NOW = crate::Reg<r32_spi1_dma_now::R32_SPI1_DMA_NOW_SPEC>;
#[doc = "SPI1 DMA current address"]
pub mod r32_spi1_dma_now;
#[doc = "R32_SPI1_DMA_BEG (rw) register accessor: an alias for `Reg<R32_SPI1_DMA_BEG_SPEC>`"]
pub type R32_SPI1_DMA_BEG = crate::Reg<r32_spi1_dma_beg::R32_SPI1_DMA_BEG_SPEC>;
#[doc = "SPI1 DMA begin address"]
pub mod r32_spi1_dma_beg;
#[doc = "R32_SPI1_DMA_END (rw) register accessor: an alias for `Reg<R32_SPI1_DMA_END_SPEC>`"]
pub type R32_SPI1_DMA_END = crate::Reg<r32_spi1_dma_end::R32_SPI1_DMA_END_SPEC>;
