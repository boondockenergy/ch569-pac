...
pub type R32_PA_PU_R = crate::FieldReader<u32, u32>;
#[doc = "Field `R32_PA_PU` writer - GPIO PA pullup resistance enable"]
pub type R32_PA_PU_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_PA_PU_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23 - GPIO PA pullup resistance enable"]
    #[inline(always)]
    pub fn r32_pa_pu(&self) -> R32_PA_PU_R {
        R32_PA_PU_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - GPIO PA pullup resistance enable"]
    #[inline(always)]
    pub fn r32_pa_pu(&mut self) -> R32_PA_PU_W<0> {
        R32_PA_PU_W::new(self)
    }
