...
pub struct W(crate::W<R8_SPI0_FIFO_COUNT1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R8_SPI0_FIFO_COUNT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R8_SPI0_FIFO_COUNT1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R8_SPI0_FIFO_COUNT1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type R8_SPI0_FIFO_COUNT1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, R8_SPI0_FIFO_COUNT1_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - SPI FIFO count statu"]
    #[inline(always)]
    pub fn r8_spi0_fifo_count1(&mut self) -> R8_SPI0_FIFO_COUNT1_W<0> {
        R8_SPI0_FIFO_COUNT1_W::new(self)
    }
...
impl crate::Writable for R8_SPI0_FIFO_COUNT1_SPEC {
    type Writer = W;
}
