...
pub struct R(crate::R<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R8_UEP2_RX_CTRL_R8_UH_RX_CTRL` writer"]
pub struct W(crate::W<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RB_UEP_RRES_MASK_RB_UH_RRES_MASK_R = crate::FieldReader<u8, u8>;
...
pub type RB_UEP_RRES_MASK_RB_UH_RRES_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC, u8, u8, 2, O>;
#[doc = "Field `RB_UEP_RRES_NO_RB_UH_RRES_NO` reader - Prepared no response and Response control bit of host receiver"]
pub type RB_UEP_RRES_NO_RB_UH_RRES_NO_R = crate::BitReader<bool>;
#[doc = "Field `RB_UEP_RRES_NO_RB_UH_RRES_NO` writer - Prepared no response and Response control bit of host receiver"]
pub type RB_UEP_RRES_NO_RB_UH_RRES_NO_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC, bool, O>;
...
pub type RB_UEP_R_TOG_MASK_RB_UH_R_TOG_MASK_R = crate::FieldReader<u8, u8>;
...
pub type RB_UEP_R_TOG_MASK_RB_UH_R_TOG_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC, u8, u8, 2, O>;
...
pub type RB_UEP_R_AUTOTOG_RB_UH_R_AUTOTOG_R = crate::BitReader<bool>;
...
impl W {
    #[doc = "Bits 0:1 - bit mask of handshake response type for USB endpoint X receiving (OUT) and Host reeiver response control bit"]
    #[inline(always)]
    pub fn rb_uep_rres_mask_rb_uh_rres_mask(&mut self) -> RB_UEP_RRES_MASK_RB_UH_RRES_MASK_W<0> {
        RB_UEP_RRES_MASK_RB_UH_RRES_MASK_W::new(self)
    }
    #[doc = "Bit 2 - Prepared no response and Response control bit of host receiver"]
    #[inline(always)]
    pub fn rb_uep_rres_no_rb_uh_rres_no(&mut self) -> RB_UEP_RRES_NO_RB_UH_RRES_NO_W<2> {
        RB_UEP_RRES_NO_RB_UH_RRES_NO_W::new(self)
    }
    #[doc = "Bits 3:4 - expected data toggle flag of USB endpoint X receiving and expected data toggle flag of host receiving (IN)"]
    #[inline(always)]
    pub fn rb_uep_r_tog_mask_rb_uh_r_tog_mask(
        &mut self,
    ) -> RB_UEP_R_TOG_MASK_RB_UH_R_TOG_MASK_W<3> {
        RB_UEP_R_TOG_MASK_RB_UH_R_TOG_MASK_W::new(self)
    }
    #[doc = "Bit 5 - enable automatic toggle after successful transfer completion on endpoint and enable automatic toggle after successful receiver completion"]
    #[inline(always)]
    pub fn rb_uep_r_autotog_rb_uh_r_autotog(&mut self) -> RB_UEP_R_AUTOTOG_RB_UH_R_AUTOTOG_W<5> {
        RB_UEP_R_AUTOTOG_RB_UH_R_AUTOTOG_W::new(self)
    }
    #[doc = "Bit 6 - expect no data packet, for high speed hub in host mode"]
    #[inline(always)]
    pub fn rb_uh_rdata_no(&mut self) -> RB_UH_RDATA_NO_W<6> {
        RB_UH_RDATA_NO_W::new(self)
    }
...
pub struct R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC;
impl crate::RegisterSpec for R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [r8_uep2_rx_ctrl_r8_uh_rx_ctrl::R](R) reader structure"]
impl crate::Readable for R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r8_uep2_rx_ctrl_r8_uh_rx_ctrl::W](W) writer structure"]
impl crate::Writable for R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R8_UEP2_RX_CTRL_R8_UH_RX_CTRL to value 0"]
impl crate::Resettable for R8_UEP2_RX_CTRL_R8_UH_RX_CTRL_SPEC {
    #[inline(always)]
