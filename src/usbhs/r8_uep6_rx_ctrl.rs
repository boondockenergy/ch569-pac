#[doc = "Register `R8_UEP6_RX_CTRL` reader"]
pub struct R(crate::R<R8_UEP6_RX_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R8_UEP6_RX_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R8_UEP6_RX_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R8_UEP6_RX_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R8_UEP6_RX_CTRL` writer"]
pub struct W(crate::W<R8_UEP6_RX_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R8_UEP6_RX_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R8_UEP6_RX_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R8_UEP6_RX_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RB_UEP_RRES_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, R8_UEP6_RX_CTRL_SPEC, u8, u8, 2, O>;
...
pub type RB_UEP_RRES_NO_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, R8_UEP6_RX_CTRL_SPEC, bool, O>;
...
pub struct R8_UEP6_RX_CTRL_SPEC;
impl crate::RegisterSpec for R8_UEP6_RX_CTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [r8_uep6_rx_ctrl::R](R) reader structure"]
impl crate::Readable for R8_UEP6_RX_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r8_uep6_rx_ctrl::W](W) writer structure"]
impl crate::Writable for R8_UEP6_RX_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R8_UEP6_RX_CTRL to value 0"]
impl crate::Resettable for R8_UEP6_RX_CTRL_SPEC {
    #[inline(always)]
