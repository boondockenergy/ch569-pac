...
pub type RB_UEP5_BUF_MOD_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
...
pub type RB_UEP5_TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
...
pub type RB_UEP5_RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
...
pub type RB_UEP6_BUF_MOD_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
...
pub type RB_UEP6_TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
...
pub type RB_UEP6_RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP5_6_MOD_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - buffer mode of USB endpoint 5(13)"]
    #[inline(always)]
    pub fn rb_uep5_buf_mod(&mut self) -> RB_UEP5_BUF_MOD_W<0> {
        RB_UEP5_BUF_MOD_W::new(self)
    }
    #[doc = "Bit 2 - enable USB endpoint 5(13) transmittal (IN)"]
    #[inline(always)]
    pub fn rb_uep5_tx_en(&mut self) -> RB_UEP5_TX_EN_W<2> {
        RB_UEP5_TX_EN_W::new(self)
    }
    #[doc = "Bit 3 - enable USB endpoint 5(13) receiving (OUT)"]
    #[inline(always)]
    pub fn rb_uep5_rx_en(&mut self) -> RB_UEP5_RX_EN_W<3> {
        RB_UEP5_RX_EN_W::new(self)
    }
    #[doc = "Bit 4 - buffer mode of USB endpoint 6(14)"]
    #[inline(always)]
    pub fn rb_uep6_buf_mod(&mut self) -> RB_UEP6_BUF_MOD_W<4> {
        RB_UEP6_BUF_MOD_W::new(self)
    }
    #[doc = "Bit 6 - enable USB endpoint 6(14) transmittal (IN)"]
    #[inline(always)]
    pub fn rb_uep6_tx_en(&mut self) -> RB_UEP6_TX_EN_W<6> {
        RB_UEP6_TX_EN_W::new(self)
    }
    #[doc = "Bit 7 - enable USB endpoint 6(14) receiving (OUT)"]
    #[inline(always)]
    pub fn rb_uep6_rx_en(&mut self) -> RB_UEP6_RX_EN_W<7> {
