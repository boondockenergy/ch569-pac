...
pub type RB_UEP7_BUF_MOD_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, O>;
...
pub type RB_UEP7_TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, O>;
...
pub type RB_UEP7_RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - buffer mode of USB endpoint 7(15)"]
    #[inline(always)]
    pub fn rb_uep7_buf_mod(&mut self) -> RB_UEP7_BUF_MOD_W<0> {
        RB_UEP7_BUF_MOD_W::new(self)
    }
    #[doc = "Bit 2 - enable USB endpoint 7(15) transmittal (IN)"]
    #[inline(always)]
    pub fn rb_uep7_tx_en(&mut self) -> RB_UEP7_TX_EN_W<2> {
        RB_UEP7_TX_EN_W::new(self)
    }
    #[doc = "Bit 3 - enable USB endpoint 7(15) receiving (OUT)"]
    #[inline(always)]
    pub fn rb_uep7_rx_en(&mut self) -> RB_UEP7_RX_EN_W<3> {
