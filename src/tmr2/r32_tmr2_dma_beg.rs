...
pub struct R(crate::R<R32_TMR2_DMA_BEG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R32_TMR2_DMA_BEG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R32_TMR2_DMA_BEG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R32_TMR2_DMA_BEG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R32_TMR2_DMA_BEG` writer"]
pub struct W(crate::W<R32_TMR2_DMA_BEG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R32_TMR2_DMA_BEG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R32_TMR2_DMA_BEG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R32_TMR2_DMA_BEG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type R16_TMR2_DMA_BEG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_TMR2_DMA_BEG_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:17 - TMR2 DMA begin address"]
    #[inline(always)]
    pub fn r16_tmr2_dma_beg(&self) -> R16_TMR2_DMA_BEG_R {
        R16_TMR2_DMA_BEG_R::new((self.bits & 0x0003_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:17 - TMR2 DMA begin address"]
...
pub struct R32_TMR2_DMA_BEG_SPEC;
impl crate::RegisterSpec for R32_TMR2_DMA_BEG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r32_tmr2_dma_beg::R](R) reader structure"]
impl crate::Readable for R32_TMR2_DMA_BEG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r32_tmr2_dma_beg::W](W) writer structure"]
impl crate::Writable for R32_TMR2_DMA_BEG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R32_TMR2_DMA_BEG to value 0"]
impl crate::Resettable for R32_TMR2_DMA_BEG_SPEC {
    #[inline(always)]
