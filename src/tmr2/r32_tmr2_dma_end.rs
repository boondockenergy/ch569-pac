...
pub struct R(crate::R<R32_TMR2_DMA_END_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R32_TMR2_DMA_END_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R32_TMR2_DMA_END_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R32_TMR2_DMA_END_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R32_TMR2_DMA_END` writer"]
pub struct W(crate::W<R32_TMR2_DMA_END_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R32_TMR2_DMA_END_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R32_TMR2_DMA_END_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R32_TMR2_DMA_END_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type R16_TMR2_DMA_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_TMR2_DMA_END_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:17 - TMR2 DMA begin address"]
    #[inline(always)]
    pub fn r16_tmr2_dma_end(&self) -> R16_TMR2_DMA_END_R {
        R16_TMR2_DMA_END_R::new((self.bits & 0x0003_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:17 - TMR2 DMA begin address"]
...
pub struct R32_TMR2_DMA_END_SPEC;
impl crate::RegisterSpec for R32_TMR2_DMA_END_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r32_tmr2_dma_end::R](R) reader structure"]
impl crate::Readable for R32_TMR2_DMA_END_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r32_tmr2_dma_end::W](W) writer structure"]
impl crate::Writable for R32_TMR2_DMA_END_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R32_TMR2_DMA_END to value 0"]
impl crate::Resettable for R32_TMR2_DMA_END_SPEC {
    #[inline(always)]
