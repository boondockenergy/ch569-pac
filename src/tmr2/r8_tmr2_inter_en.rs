...
pub type RB_TMR_IE_FIFO_HF_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, R8_TMR2_INTER_EN_SPEC, bool, O>;
#[doc = "Field `RB_TMR_IE_DMA_END` reader - enable interrupt for timer1_2 DMA completion"]
pub type RB_TMR_IE_DMA_END_R = crate::BitReader<bool>;
#[doc = "Field `RB_TMR_IE_DMA_END` writer - enable interrupt for timer1_2 DMA completion"]
