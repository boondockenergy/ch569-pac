...
#[doc = "Field `R32_TMR2_CNT_END` reader - TMR current count"]
pub type R32_TMR2_CNT_END_R = crate::FieldReader<u32, u32>;
#[doc = "Field `R32_TMR2_CNT_END` writer - TMR current count"]
pub type R32_TMR2_CNT_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_TMR2_CNT_END_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - TMR current count"]
    #[inline(always)]
    pub fn r32_tmr2_cnt_end(&self) -> R32_TMR2_CNT_END_R {
        R32_TMR2_CNT_END_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - TMR current count"]
    #[inline(always)]
    pub fn r32_tmr2_cnt_end(&mut self) -> R32_TMR2_CNT_END_W<0> {
        R32_TMR2_CNT_END_W::new(self)
    }
