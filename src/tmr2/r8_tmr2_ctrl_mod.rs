...
pub type RB_TMR_OUT_POLAR_RB_TMR_CAP_COUNT_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, R8_TMR2_CTRL_MOD_SPEC, bool, O>;
#[doc = "Field `RB_TMR_PWM_REPEAT_RB_TMR_CAP_EDGE` reader - timer PWM repeat mode _timer capture edge mode"]
pub type RB_TMR_PWM_REPEAT_RB_TMR_CAP_EDGE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RB_TMR_PWM_REPEAT_RB_TMR_CAP_EDGE` writer - timer PWM repeat mode _timer capture edge mode"]
