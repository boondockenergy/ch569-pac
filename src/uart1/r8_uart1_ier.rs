...
pub type RB_IER_RECV_RDY_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_IER_SPEC, bool, O>;
...
pub type RB_IER_THR_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_IER_SPEC, bool, O>;
...
pub type RB_IER_LINE_STAT_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_IER_SPEC, bool, O>;
...
pub type RB_IER_TXD_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_IER_SPEC, bool, O>;
...
pub type RB_IER_RESET_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_IER_SPEC, bool, O>;
impl R {
