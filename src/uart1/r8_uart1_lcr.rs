...
pub type RB_LCR_STOP_BIT_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_LCR_SPEC, bool, O>;
...
pub type RB_LCR_PAR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_LCR_SPEC, bool, O>;
...
pub type RB_LCR_BREAK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, R8_UART1_LCR_SPEC, bool, O>;
#[doc = "Field `RB_LCR_DLAB_RB_LCR_GP_BIT` reader - UART reserved bit _ UART general purpose bit"]
pub type RB_LCR_DLAB_RB_LCR_GP_BIT_R = crate::BitReader<bool>;
#[doc = "Field `RB_LCR_DLAB_RB_LCR_GP_BIT` writer - UART reserved bit _ UART general purpose bit"]
