...
pub struct R(crate::R<R32_PFIC_IENR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R32_PFIC_IENR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R32_PFIC_IENR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R32_PFIC_IENR1_SPEC>) -> Self {
        R(reader)
    }
}
...
impl crate::Readable for R32_PFIC_IENR1_SPEC {
    type Reader = R;
}
