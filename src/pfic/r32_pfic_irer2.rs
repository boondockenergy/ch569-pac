...
pub struct R(crate::R<R32_PFIC_IRER2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R32_PFIC_IRER2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R32_PFIC_IRER2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R32_PFIC_IRER2_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type INTRESET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R32_PFIC_IRER2_SPEC, u32, u32, 28, O>;
impl R {
...
impl crate::Readable for R32_PFIC_IRER2_SPEC {
    type Reader = R;
}
